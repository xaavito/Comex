...
Partial Class BuscarBackupForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.BackupDataGrid = New Comex.MyDataGrid()
        ...
        Me.RealizarBackupButton = New Comex.MyButton()
        Me.EliminarBackupButton = New Comex.MyButton()
        Me.DescripcionBackupTextBox = New Comex.MyTextBox()
    ...
    Friend WithEvents BackupDataGrid As Comex.MyDataGrid
    Friend WithEvents RealizarBackupButton As Comex.MyButton
    Friend WithEvents EliminarBackupButton As Comex.MyButton
    Friend WithEvents DescripcionBackupTextBox As Comex.MyTextBox
